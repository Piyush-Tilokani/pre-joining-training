...
class ComparableEmployee implements Comparable<ComparableEmployee> {
    ...
    public ComparableEmployee(int id, String name, double salary) {
        this.id = id;
        this.name = name;
        this.salary = salary;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComparableEmployee)) return false;
...
class NameAscendingComparator implements Comparator<ComparableEmployee> {
...
class SalaryAscendingComparator implements Comparator<ComparableEmployee> {
...
public class CollectionsSorting {
    public static void main(String[] args) {
        List<ComparableEmployee> employeeList = new ArrayList<>();
        employeeList.add(new ComparableEmployee(3, "Shashwat", 58000));
        employeeList.add(new ComparableEmployee(1, "Piyush", 60000));
        employeeList.add(new ComparableEmployee(2, "Atharva", 55000));
        employeeList.add(new ComparableEmployee(4, "Ajinkya", 59000));
